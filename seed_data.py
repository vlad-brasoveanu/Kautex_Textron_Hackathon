...
EMPLOYEES = [
    # CAE
    ("Markus Weber", "CAE Germany", "CAE", "Germany", 1600.0, 150.0, "Dr. Müller", "Lead CAE expert in crash simulations.", "Active"),
    ("Sofia Rossi", "CAE Germany", "CAE", "Germany", 1600.0, 140.0, "Dr. Müller", "Structural durability specialist.", "Active"),
    ("Hans Becker", "CAE Germany", "CAE", "Germany", 1600.0, 135.0, "Dr. Müller", "NVH simulation engineer.", "Active"),
    ("Priya Sharma", "CAE India", "CAE", "India", 1800.0, 49.55, "Rajesh Kumar", "Mesh generation specialist.", "Active"),
    ("Ravi Patel", "CAE India", "CAE", "India", 1800.0, 47.0, "Rajesh Kumar", "Junior CAE analyst, onboarded this quarter.", "New Position"),
    ("Carlos Hernández", "CAE Mexico", "CAE", "Mexico", 1800.0, 40.0, "Sofia Gomez", "FEA analyst.", "Active"),
    ("Diego Alvarez", "CAE Mexico", "CAE", "Mexico", 1800.0, 44.0, "Sofia Gomez", "Crash safety lead.", "Active"),
    ("Andreea Ionescu", "CAE Romania", "CAE", "Romania", 1768.0, 71.77, "Andrei Popescu", "Thermal simulation expert.", "Active"),
    ("Elena Popa", "CAE Romania", "CAE", "Romania", 1768.0, 68.0, "Andrei Popescu", "Composite materials analyst.", "Active"),
    ("Katarzyna Nowak", "CAE Poland", "CAE", "Poland", 1720.0, 60.0, "Andrei Popescu", "Fatigue and durability CAE lead.", "Active"),
    # Test
    ("Lukas Fischer", "Test Bonn", "Test", "Germany", 1600.0, 120.0, "Dr. Müller", "Senior validation engineer.", "Active"),
    ("Julia Schmidt", "Test Bonn", "Test", "Germany", 1600.0, 115.0, "Dr. Müller", "Environmental test lab lead.", "Active"),
    ("Arjun Mehta", "Test India", "Test", "India", 1800.0, 45.0, "Rajesh Kumar", "Test rig operator.", "Active"),
    ("Neha Verma", "Test India", "Test", "India", 1800.0, 43.0, "Rajesh Kumar", "Durability test technician.", "Active"),
    ("Ana Martínez", "Test Mexico", "Test", "Mexico", 1800.0, 38.0, "Sofia Gomez", "Physical durability testing.", "Active"),
    ("Roberto Silva", "Test Mexico", "Test", "Mexico", 1800.0, 39.0, "Sofia Gomez", "Test fixture designer.", "Active"),
    ("Mihai Dumitrescu", "Test Romania", "Test", "Romania", 1768.0, 65.0, "Andrei Popescu", "Electronics validation lead.", "Active"),
    ("Michael Johnson", "Test Troy", "Test", "USA", 1800.0, 130.0, "John Smith", "Customer liaison validation lead.", "Active"),
    ("Tom Anderson", "Test Troy", "Test", "USA", 1800.0, 125.0, "John Smith", "Powertrain test engineer.", "Active"),
    ("Wei Zhang", "Test Pinghu", "Test", "China", 1800.0, 52.0, "Li Wei", "Environmental chamber validator.", "Active"),
    # Program Management
...
TOPICS = [
    ("Non bookable - Other", "Internal Efforts", "Management",
    ...
    ("bookable 1 - Consulting Global", "Internal Efforts", "Customer Engineering",
    ...
    ("Fuel Project", "Customer Requests", "Customer Engineering",
    ...
    ("Method Development Pentatonic", "Pentatonic Projects", "CAE",
    ...
    ("Electric Powertrain Integration", "Customer Requests", "Customer Engineering",
    ...
    ("Manufacturing Line Digitalization", "Manufacturing Projects", "Manufacturing Engineering",
    ...
    ("Lightweight Materials Research", "Internal Efforts", "Research",
    ...
    ("Customer Field Support - APAC", "Customer Requests", "Customer Engineering",
...
def seed():
    ...
    stretch_employees += [
        ("Yuki Tanaka", "Test Pinghu", "Test", "China", 1800.0, 50.0, "Li Wei", "New hire supporting APAC test capacity growth.", "New Position"),
